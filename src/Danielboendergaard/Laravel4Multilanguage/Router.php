...
class Router extends BaseRouter {
     ...
     * @param  string $locale
     * @return \Danielboendergaard\Laravel4Multilanguage\Router
     */
    public function __construct(Container $container = null, $locale = null)
    {
    ...
    protected function createRoute($method, $pattern, $action)
    {
        ...
        // Prefix all routes with the locale
        if ($this->locale) $pattern = $this->addPrefix($pattern, $this->locale);
