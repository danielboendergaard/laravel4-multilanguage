...
use Danielboendergaard\Laravel4Multilanguage\Router;
use Danielboendergaard\Laravel4Multilanguage\UrlGenerator;
...
class RoutingUrlGeneratorTest extends PHPUnit_Framework_TestCase {
    ...
    protected function getMultilingualGenerator()
    {
        ...
        return new UrlGenerator($router->getRoutes(), Request::create('/'), 'en');
    }
}